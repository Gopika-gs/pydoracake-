"""
Django settings for pydoracake project.
...
SECRET_KEY = '*puu)r@$u&r6^*_#n2texyj$+9l$yf6n3-+9zz7gv&2!p2v@d='
...
WSGI_APPLICATION = 'pydoracake.wsgi.application'
...
DATABASES = {
    'default': {
	    ...
	    'NAME': 'pydora_db',#Name of the database created for this project
